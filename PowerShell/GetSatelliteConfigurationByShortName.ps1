function Get-SatelliteConfigurationByShortName
{
    [CmdletBinding()]
    ...
    Process
    {
        ...
        [PSCustomObject]$SatelliteConfiguration = $VaultManager.getSatelliteConfiguration($VaultConnection,$Customer.Id) |
            Select-Object -Property *
    }
    End
    {
